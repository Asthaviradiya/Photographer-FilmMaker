   ...
   <motion.section initial= {{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}} transition={transition1} className='section'>
    <div className='container mx-auto h-full relative'>
      ...
      <div className='flex flex-col justify-center'>
        {/* text-wrapper */}
      <motion.div initial= {{opacity: 0, y: '-50%'}} animate={{opacity: 1, y: 0}} exit={{opacity: 0, y: '-50%'}} className='w-full pt-36 pb-14 lg:pt-0 lg:pb-15 lg:w-auto z-10 lg:absolute flex flex-col justify-center items-center lg:items-start'>
